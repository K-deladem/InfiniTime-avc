// ============================================================================
// MovementWatchFace.cpp - Implementation de la watchface de mouvement
// ============================================================================
...
MovementWatchFace::MovementWatchFace([[maybe_unused]] DisplayApp* app)
    : Screen() {
  // Note: Screen base class doesn't take parameters
  // The app parameter is kept for API compatibility with other screens
  CreateUI();
  Refresh();
}
...
void MovementWatchFace::CreateUI() {
  ...
  // ========================================================================
  // Ligne 2: Temps actif (Axis time) - Jaune
  // ========================================================================
  ...
  // ========================================================================
  // Ligne 3: Magnitude time et Axis time - Cyan/Lime
  // ========================================================================
...
void MovementWatchFace::UpdateMovementData() {
  ...
  // Note: Status structure doesn't have accel_x/y/z fields
  // Display fixed values - integrate real accelerometer data as needed
  // ========================================================================
  static char accel_str[64];
  std::snprintf(accel_str, sizeof(accel_str), 
                "X:0.00 Y:0.00 Z:0.00 g");
